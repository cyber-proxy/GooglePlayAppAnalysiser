...
AppAnnieAppAddr = "https://www.appannie.com/ajax/top-chart/table/?market=google-play&country_code=US&category=1&date=2019-03-28&rank_sorting_type=rank&page_size=100&order_type=desc"
...
GET_HEADERS = {
    'authority': 'www.appannie.com',
    'method': 'GET',
    'path': '/ajax/top-chart/table/?market=google-play&country_code=US&category=1&date=2019-03-28&rank_sorting_type=rank&page_size=100&order_type=desc',
    'scheme': 'https',
    ...
    'dnt': '1',
    'referer': 'https://www.appannie.com/apps/google-play/top-chart/?country=US&category=1&device=&date=2019-03-28&feed=All&rank_sorting_type=rank&page_number=0&page_size=100&table_selections=',
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36',
    'x-csrftoken': 'OkjUyLjK9dmK5boFO5ZXdvoibZSmVAPc',
    'x-newrelic-id': 'VwcPUFJXGwEBUlJSDgc=',
    'x-requested-with': 'XMLHttpRequest'
